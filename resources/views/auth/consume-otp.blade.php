...
<body>
        ...
        <div class="content">
            ...
            <div style="width:70%;margin:0 auto; margin-top:2em">
                ...
                <div class="input-form-v1">
                    ...
                    <div class="input">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_1" class="input-one-char" oninput="this.value == '' ?otp_code_1.focus() : otp_code_2.focus()">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_2" class="input-one-char" oninput="this.value == '' ?otp_code_1.focus() : otp_code_3.focus()">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_3" class="input-one-char" oninput="this.value == '' ?otp_code_2.focus() : otp_code_4.focus()">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_4" class="input-one-char" oninput="this.value == '' ?otp_code_3.focus() : otp_code_5.focus()">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_5" class="input-one-char" oninput="this.value == '' ?otp_code_4.focus() : otp_code_6.focus()">
                        <input type="text" maxlength="1" placeholder="-" required id="otp_code_6" class="input-one-char" oninput="this.value == '' ? otp_code_5.focus() : void(0); checkAllCodes();">
                    </div>
                </div>
    ...
    <script>
        (function() {
            document.querySelectorAll('.input > input').forEach(e => e.addEventListener('paste', function(event) { 

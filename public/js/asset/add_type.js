...
class FieldCollection {
    ...
    async processFieldData() {
        ...
        let content = `<div style="position:relative; height: 4em; width:100%; border:1px solid gray; border-radius:0.5em;margin-top:0.4em; background-color:rgb(250,250,250)">
    ...
    async submit() {
        ...
        let name = "";
        let response = await fetcher.sendFormData("/laportadiroma/create-new-asset", {type: "POST", data: {name: name, fields: this.fields}, wantJSON: true})
